...
@if not "%WindowsSdkDir%" == "" @set LIBPATH=%WindowsSdkDir%References\CommonConfiguration\Neutral;%ExtensionSDKDir%\Microsoft.VCLibs\14.0\References\CommonConfiguration\neutral;%LIBPATH%

@if not "%UniversalCRTSdkDir%" == "" @set INCLUDE=%UniversalCRTSdkDir%\include\10.0.10056.0\ucrt;%INCLUDE%
@if not "%UniversalCRTSdkDir%" == "" @set LIB=%UniversalCRTSdkDir%\lib\10.0.10056.0\ucrt\x64;%LIB%
